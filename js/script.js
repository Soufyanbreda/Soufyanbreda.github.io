...
function scrollto (x) {
  $('html, body').animate({
    scrollTop: $("div#" + x).offset().top -110
  }, 1000)
};
...
$('#techtable3').hide();
$('#techtable4').hide();
document.getElementById("link1").style.color = "#0078f3";
...
document.getElementById("link2").style.color = "#0078f3";
document.getElementById("link3").style.color = "#000";
document.getElementById("link4").style.color = "#000";
}
function table3 (){
...
document.getElementById("link1").style.color = "#000";
document.getElementById("link2").style.color = "#000";
document.getElementById("link3").style.color = "#0078f3";
document.getElementById("link4").style.color = "#000";
}
function table4 (){
$('#techtable1').hide();
...
document.getElementById("link2").style.color = "#000";
document.getElementById("link3").style.color = "#000";
document.getElementById("link4").style.color = "#0078f3";
}
